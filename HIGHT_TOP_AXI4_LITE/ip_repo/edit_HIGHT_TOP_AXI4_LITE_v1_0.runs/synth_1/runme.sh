...
HD_PWD='d:/project/osp/microblaze_based_hight_crypto_soc/hight_top_axi4_lite/ip_repo/edit_HIGHT_TOP_AXI4_LITE_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HIGHT_TOP_AXI4_LITE_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HIGHT_TOP_AXI4_LITE_v1_0.tcl
